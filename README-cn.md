...
3. 告诉智能体：宿主机 IP、SSH 凭据、代理地址（如有）以及你的 Copilot 或 OpenAI API key。
4. 智能体将自动完成：安装 Docker Desktop、切换到 Windows 容器模式、构建 `shotwright:allinone`、配置 `.env`、启动完整平台。
5. 智能体报告完成后，访问 `http://<host-ip>:3000`。
