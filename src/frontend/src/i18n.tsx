...
const catalogs = {
  "zh-CN": {
    ...
    agent: {
      ...
      workflowDescription: "当你选中某个会话后，右侧显示该会话当前绑定的工程、容器状态和最近渲染；执行过程会直接出现在中间对话流里。",
      workflowSteps: [
        "先创建一个聊天会话。",
  ...
  "en-US": {
    ...
    agent: {
      ...
      workflowDescription: "When a session is selected, the right sidebar shows project binding, runtime state, and the latest render, while the execution flow stays in the middle transcript.",
      workflowSteps: [
